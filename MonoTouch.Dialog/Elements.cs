...
namespace MonoTouch.Dialog
{
	...
	public class StringElement : Element {
		...
		public StringElement (string caption,string value,  Action tapped) : base (caption)
		{
			this.Value = value;
			Tapped += tapped;
		}
	...
	public class ImageStringElement : StringElement {
		...
		public ImageStringElement (string caption, UIImage image, Action tapped) : base (caption, tapped)
		{
			this.image = image;
			this.Accessory = UITableViewCellAccessory.None;
		}
	...
	public class MultilineElement : StringElement, IElementSizing {
		...
		public MultilineElement (string caption,string theValue, Action tapped) : base (caption, tapped)
		{
			this.Value= theValue;
		}
	...
	public class RadioElement : StringElement {
		...
		public RadioElement (string caption, string group, Action tapped) : base (caption)
		{
			Tapped += tapped;
			Group = group;
		}
	...
	public class RadioImageElement : BadgeElement {
		...
		public RadioImageElement (string caption, string group, Action tapped) : base (null,caption,"")
		{
			Tapped += tapped;
			Group = group;
		}
		...
		public RadioImageElement (string caption, string group,string value, UIImage image, Action tapped) : base (image,caption,"")
		{
			Tapped += tapped;
			Group = group;
			Value = value;
	...
	public class EntryElement : Element {
		...
		public override UITableViewCell GetCell (UITableView tv)
		{
			...
			if (entry == null){
				...
				var _entry = new UITextField (new CGRect (size.Width, (cell.ContentView.Bounds.Height-size.Height)/2-1, 320-size.Width - 15, size.Height)){
					Tag = 1,
